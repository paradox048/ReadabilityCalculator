...
public class Readability {
        ...
        /**
         * calculates the amount of characters in the passed String
         ...
         */
        private static double calculateAriScore(int words, int characters, int sentences) {
         ...
         */
        private static double clIndex(int characters, int sentences, int words) {
